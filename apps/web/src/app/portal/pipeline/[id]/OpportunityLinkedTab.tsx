...
export function OpportunityLinkedTab({
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-2xl border border-[color:var(--wp-surface-card-border)] bg-[color:var(--wp-surface-card)] shadow-sm p-5">
        <h3 className="text-[10px] font-black uppercase tracking-widest text-[color:var(--wp-text-tertiary)] mb-4 flex items-center gap-2">
        ...
        {contactId ? (
          ...
          <p className="text-sm font-semibold text-[color:var(--wp-text-secondary)]">Nepřiřazeno</p>
        )}
      </div>
      ...
      <div className="rounded-2xl border border-[color:var(--wp-surface-card-border)] bg-[color:var(--wp-surface-card)] shadow-sm p-5">
        ...
        {events.length === 0 ? (
          <p className="text-sm font-medium text-[color:var(--wp-text-secondary)]">Žádné schůzky k tomuto obchodu.</p>
        ) : (
          <ul className="space-y-2">
            {events.slice(0, 10).map((e) => (
              <li
                key={e.id}
                className="text-sm font-semibold text-[color:var(--wp-text)] py-2 px-3 rounded-xl bg-[color:var(--wp-surface-muted)] border border-[color:var(--wp-surface-card-border)]"
              >
                {e.title}{" "}
                <span className="text-[color:var(--wp-text-secondary)] font-medium block sm:inline sm:ml-1 mt-0.5 sm:mt-0">
                  {new Date(e.startAt).toLocaleString("cs-CZ")}
                </span>
              </li>
            ))}
            {events.length > 10 && (
              <li className="text-[color:var(--wp-text-secondary)] text-xs font-bold uppercase tracking-wider pt-1">
      ...
      <div className="rounded-2xl border border-[color:var(--wp-surface-card-border)] bg-[color:var(--wp-surface-card)] shadow-sm p-5">
        ...
        {tasks.length === 0 ? (
          <p className="text-sm font-medium text-[color:var(--wp-text-secondary)]">Žádné úkoly k tomuto obchodu.</p>
        ) : (
          <ul className="space-y-2">
