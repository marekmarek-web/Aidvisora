...
import { TrendingUp, Calculator, HeartPulse } from "lucide-react";
...
const CALC_CARDS = [
  {
    ...
    description: "Projekce zhodnocení – hodnota investice v čase podle strategie.",
  },
  {
    href: "/portal/calculators/mortgage",
    icon: Calculator,
...
export function PensionCtaCards() {
  return (
