...
export function TeamOverviewPerformanceTrendSection({ performanceOverTime }: { performanceOverTime: TeamPerformancePoint[] }) {
  ...
  return (
    <section className="overflow-hidden rounded-[28px] border border-slate-200/80 bg-white shadow-[0_12px_36px_rgba(15,23,42,0.055)]">
      <div className="border-b border-slate-100 px-7 py-5">
        <h2 className="text-[17px] font-black tracking-tight text-slate-950">Trend výkonu (CRM)</h2>
        <p className="mt-1 text-[12px] text-slate-500">Jednotky po obdobích — rychlá orientace.</p>
      </div>
