...
export default function FinancialAnalysisPageClient({
  fundLibrarySnapshot,
}: {
  ...
  useEffect(() => {
    ...
    hydrate();
    setLoadState("ok");
  }, [searchParams, hydrate, loadFromServerPayload, setAnalysisId, setLinkIds, loadFromFile, setLinkMetadata]);
  ...
  return (
    <FundLibraryFaProvider snapshot={fundLibrarySnapshot}>
      <FinancialAnalysisLayout />
    </FundLibraryFaProvider>
  );
}
