...
export function AIReviewTopBar({
  ...
  return (
    <header className="bg-[color:var(--wp-surface-card)] px-4 md:px-6 py-3 md:py-4 border-b border-[color:var(--wp-surface-card-border)] flex items-center justify-between shadow-sm z-20 flex-shrink-0">
