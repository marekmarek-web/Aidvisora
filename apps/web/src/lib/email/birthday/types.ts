...
/** Soubory v `public/` — hlavní animovaný obrázek je GIF; PNG jen záloha. */
export const BIRTHDAY_DECOR_IMAGE_FILENAMES = ["birthday-freepik.gif", "birthday-freepik.png"] as const;
