  ...
  <div class="sb-brand">
    <div class="sb-logo">
      <div class="sb-logo-mark">
        <img src="/Aidvisora%20logo.png" alt="Aidvisora logo" class="sb-logo-img" onerror="this.style.display='none';if(this.nextElementSibling)this.nextElementSibling.style.display='inline'">
