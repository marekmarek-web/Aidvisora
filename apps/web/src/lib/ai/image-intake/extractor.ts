...
const FACT_KEY_TO_TYPE: Record<string, FactType> = {
  ...
  id_doc_is_identity_document: "document_received",
  id_doc_first_name: "document_received",
  id_doc_last_name: "document_received",
  id_doc_birth_date: "document_received",
  id_doc_street: "document_received",
  id_doc_city: "document_received",
  id_doc_zip: "document_received",
  id_doc_personal_id: "document_received",
  id_doc_email: "document_received",
  id_doc_phone: "document_received",
  id_doc_title: "document_received",
  id_doc_extra_notes: "document_received",
...
function factKeyLabel(key: string): string {
  ...
  const labels: Record<string, string> = {
    ...
    payment_frequency: "Frekvence plateb",
