...
-- One unique index (avoid duplicate with UNIQUE constraint + Drizzle index; see migrations/supabase-performance-advisor-2026-04-01.sql)
...
-- Dashboard KPIs + badge dotazy (idempotent; viz packages/db/migrations/dashboard_kpis_indexes.sql)
...
-- Nepřečtené zprávy od klientů (sidebar badge)
